...
export const IconLeftArrow = (props) => {
  return(
    <svg  
      ...
      height={props.height}
      fill="currentColor" 
      className="left-arrow bi bi-arrow-left-square" 
      viewBox="0 0 16 16"
      id='oi'
    >
      <path 
...
export const IconBackArrow = (props) => {
  return(
    <svg 
      ...
      height={props.height}
      fill="currentColor" 
      className="back-arrow bi bi-box-arrow-in-up-left" 
      viewBox="0 0 16 16"
    >
      <path 
        fillRule="evenodd" 
...
export const IconDashCircle = (props) => {
  return(
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props.width}
      height={props.height}
      fill="currentColor" 
      className="dash-circle bi bi-dash-circle" 
      viewBox="0 0 16 16"
    >
      <path 
...
export const IconPlusCircle = (props) => {
  return(
    <svg 
      ...
      height={props.height}
      fill="currentColor" 
      className="plus-circle bi bi-plus-circle" 
      viewBox="0 0 16 16"
    >
      <path 
        d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"
